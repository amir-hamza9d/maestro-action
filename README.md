...
│
├── hooks/                          # Reusable test components
│   ├── beforeHook.yaml             # Setup operations run before tests
│   └── afterHook.yaml              # Cleanup + visual regression testing
│
...
│
├── Screen-shots/                   # Screenshots for visual regression testing
│   ├── Expected/                   # Baseline screenshots
│   ├── Actual/                     # Screenshots from current run
│   └── Diff/                       # Generated difference images
│
├── artifacts/                      # Test reports and failure artifacts
│
├── app-elements/                   # JS helper files for test flows
│
└── .github/
